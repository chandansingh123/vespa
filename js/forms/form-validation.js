...
$(document).ready(function(){
    $('.submit').click(function(event){
        ...
        if(email.length > 5 && email.includes('@') && email.includes('.')){
            statusEln.append('email is valid')
        }else{
            statusEln.append('email is not valid')
        }
        if(phone.length >=10){
            statusEln.append('phone is valid')
        }else{
            statusEln.append('phone is not valid')
        }
        if(message.length >=20){
            statusEln.append('message is valid')        
        }else{
            statusEln.append('message is not valid')
        }
